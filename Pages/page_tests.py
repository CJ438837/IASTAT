...
def app():
    ...
    st.markdown("### 💡 Tests statistiques proposés")

    lancer_tests = st.button("🧠 Générer la liste de tests proposés")

    if lancer_tests:
        with st.spinner("Analyse des variables et préparation des tests... ⏳"):
